...
const CardSet = (props) => {
	...
	useEffect(() => {
		const onAppliedFilters = () => {
			if (props.reducedState.minForks !== '' && props.reducedState.maxForks === '') {
				setForksQuery(`forks:>=${props.reducedState.minForks}`);
			} else if (props.reducedState.maxForks !== '' && props.reducedState.minForks === '') {
			...
			if (props.reducedState.minStars !== '' && props.reducedState.maxStars === '') {
				setStarsQuery(`stars:>=${props.reducedState.minForks}`);
			} else if (props.reducedState.maxStars !== '' && props.reducedState.minStars === '') {
	...
	return (
		<div
			...
			{isLoading ? (
				...
				<div className={classes.cardSet} style={{ justifyContent: 'center' }}>
